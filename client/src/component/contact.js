...
export default function contact() {
    ...
    return (
        <div className='contact'>
                    ...
                    <div className='row'>
                        <div className='col-sm-6 col-12'>
                            <div className='desc'>
                                ...
                                <p>เตรียมพบบ้านและทาวน์โฮมโครงการใหม่ ให้คุณได้ใช้ชีวิตติดไลฟ์สไตล์ใจกลางกรุงเทพฯโซนเหนือ</p>
                                <ul>
                        ...
                        <div className='col-sm-6 col-12'>
                            <div className='map'>
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3870.9662112177!2d100.61989993508847!3d14.020017243842641!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x2d416d14ace0ff96!2zMTTCsDAxJzAwLjciTiAxMDDCsDM3JzE3LjAiRQ!5e0!3m2!1sen!2sth!4v1659676227648!5m2!1sen!2sth" id="ggmap" frameBorder="0" style={{ border: 0 }} allowFullScreen="" aria-hidden="false" tabIndex="0"></iframe>                        
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className='foot'>
                <div className='logo2'>
                    <a href="https://corp.siameseasset.co.th" ><img src={logo2} /></a>
                </div>
                <div className='copyright'>
                    <p>Copyright © 2019 All rights reserved.</p>
                    <div className='ifb'>
                        <a href="https://web.facebook.com/SiameseAssetThailand"><img className='borderr' src={fb} /></a>
                    </div>
